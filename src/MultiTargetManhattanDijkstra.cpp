...
auto MultiTargetManhattanDijkstra::findRoutes(const graph::Node& source, const std::vector<graph::Node>& targets)
...
auto MultiTargetManhattanDijkstra::computeDistances(const graph::Node& source, const std::vector<graph::Node>& targets)
